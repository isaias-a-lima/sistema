<div class="row">
    <div class="col-sm-12 col-md-12" style="min-height: 400px;">
        ...
        <div class="menu">
            ...
            <button type="button" class="btn btn-danger">
                <span class="glyphicon glyphicon-hand-right"></span> À fazer
            </button>
            <button type="button" class="btn btn-danger">
                <span class="glyphicon glyphicon-hand-up"></span> Fazendo
            </button>
            <button type="button" class="btn btn-danger">
                <span class="glyphicon glyphicon-thumbs-up"></span> Concluídas
            </button>
        </div>
